...
const Attendance = () => {
  ...
  useEffect(() => {
    fetchAttendanceData();
  }, [selectedCohort, debouncedSearch, pagination.currentPage]);
  ...
  const fetchAttendanceData = async () => {
    try {
      ...
      const response = await axiosInstance.get(
        `/session/attendance?${queryParams}`
      );
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div className="mb-4 sm:mb-0">
              ...
              <p className="mt-1 text-sm text-gray-500">
                View and manage participant attendance records
              </p>
            </div>
          </div>
        </div>
              ...
              <tbody className="divide-y divide-gray-200 bg-white">
                {loading ? (
                  ...
                  attendanceData.map((participant) => {
                    const presentCount = participant.sessions.filter(
                    ...
                    return (
                      <tr
                        ...
                        onClick={() =>
                          navigate(`/attendance/${participant.participantId}`)
                        }
                      >
